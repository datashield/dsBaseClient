...
test_that("lspline", {
    ...
    expect_equal(res.mod$coefficients['(Intercept)','Estimate'], -5.46584429)
    expect_equal(res.mod$coefficients['lsplineDS1','Estimate'], 0.42499237)
    expect_equal(res.mod$coefficients['lsplineDS2','Estimate'], 0.10396672)
    expect_equal(res.mod$coefficients['lsplineDS3','Estimate'], 0.05051422)
    expect_equal(res.mod$coefficients['lsplineDS4','Estimate'], 0.24522708)
    expect_equal(res.mod$coefficients['(Intercept)','Std. Error'], 1.340072623)
    expect_equal(res.mod$coefficients['lsplineDS1','Std. Error'], 0.090653306)
    expect_equal(res.mod$coefficients['lsplineDS2','Std. Error'], 0.010498879)
    expect_equal(res.mod$coefficients['lsplineDS3','Std. Error'], 0.006418973)
    expect_equal(res.mod$coefficients['lsplineDS4','Std. Error'], 0.023139549)
    expect_equal(res.mod$dev, 16909.8, tolerance=0.00001)
