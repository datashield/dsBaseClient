...
init.ip.address()
  ...
  ds.test_env$user_1 <- "admin"
  ds.test_env$user_2 <- "admin"
  ds.test_env$user_3 <- "admin"

  ds.test_env$password_1 <- "admin"
  ds.test_env$password_2 <- "admin"
  ds.test_env$password_3 <- "admin"
