...
test_that("simple test, error", {
    ...
    expect_equal(res.errors$survival1, "Command 'sampleDS(x.transmit = \"D$survtime\", size.transmit = \"30\", replace.transmit = FALSE, \n    prob.transmit = NULL)' failed on 'survival1': Error while evaluating 'is.null(base::assign('no.obj', value={dsBase::sampleDS(x.transmit = \"D$survtime\", size.transmit = \"30\", replace.transmit = FALSE, prob.transmit = NULL)}))' -> Error in dsBase::sampleDS(x.transmit = \"D$survtime\", size.transmit = \"30\",  : \n  FAILED: if sampling without replacement size must be less than or equal to length(x)FALSE\n", fixed=TRUE)
    expect_equal(res.errors$survival2, "Command 'sampleDS(x.transmit = \"D$survtime\", size.transmit = \"30\", replace.transmit = FALSE, \n    prob.transmit = NULL)' failed on 'survival2': Error while evaluating 'is.null(base::assign('no.obj', value={dsBase::sampleDS(x.transmit = \"D$survtime\", size.transmit = \"30\", replace.transmit = FALSE, prob.transmit = NULL)}))' -> Error in dsBase::sampleDS(x.transmit = \"D$survtime\", size.transmit = \"30\",  : \n  FAILED: if sampling without replacement size must be less than or equal to length(x)FALSE\n", fixed=TRUE)
    expect_equal(res.errors$survival3, "Command 'sampleDS(x.transmit = \"D$survtime\", size.transmit = \"30\", replace.transmit = FALSE, \n    prob.transmit = NULL)' failed on 'survival3': Error while evaluating 'is.null(base::assign('no.obj', value={dsBase::sampleDS(x.transmit = \"D$survtime\", size.transmit = \"30\", replace.transmit = FALSE, prob.transmit = NULL)}))' -> Error in dsBase::sampleDS(x.transmit = \"D$survtime\", size.transmit = \"30\",  : \n  FAILED: if sampling without replacement size must be less than or equal to length(x)FALSE\n", fixed=TRUE)
})
