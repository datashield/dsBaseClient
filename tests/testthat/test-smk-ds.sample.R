...
test_that("simple test", {
    ...
    expect_equal(res1_colnames$survival1[1], "survtime")
    expect_equal(res1_colnames$survival1[2], "time.id")
    ...
    expect_equal(res1_colnames$survival2[1], "survtime")
    expect_equal(res1_colnames$survival2[2], "time.id")
    ...
    expect_equal(res1_colnames$survival3[1], "survtime")
    expect_equal(res1_colnames$survival3[2], "time.id")
...
test_that("simple test, error", {
    ...
    expect_equal(res.errors$survival1, "Execution failed: Error : FAILED: if sampling without replacement size must be less than or equal to length(x)", fixed=TRUE)
    expect_equal(res.errors$survival2, "Execution failed: Error : FAILED: if sampling without replacement size must be less than or equal to length(x)", fixed=TRUE)
    expect_equal(res.errors$survival3, "Execution failed: Error : FAILED: if sampling without replacement size must be less than or equal to length(x)", fixed=TRUE)
})
