...
test_that("missing variable", {
    ...
    expect_match(res.errors$study1, "* Error : object 'LAB_MISSING' not found")
    expect_match(res.errors$study2, "* Error : object 'LAB_MISSING' not found")
    expect_match(res.errors$study3, "* Error : object 'LAB_MISSING' not found")
})
