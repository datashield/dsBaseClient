...
# context("ds.rPois::discctrl::setup")
...
# Tests
#
# context("ds.rPois::discctrl")
test_that("simple c", {
    expect_error(ds.rPois(samp.size = 50, lambda = 1, newobj = "pois_dist", seed.as.integer = 27), "There are some DataSHIELD errors, list them with datashield.errors()", fixed = TRUE)
...
# context("ds.rPois::discctrl::shutdown")
...
# context("ds.rPois::discctrl::done")
