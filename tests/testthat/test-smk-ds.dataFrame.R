...
test_that("dataframe_exists, from dataframe variables", {
    ...
    expect_length(res.colnames, 3)
    expect_length(res.colnames$sim1, 2)
    expect_equal(res.colnames$sim1[1], "D$LAB_TSC")
    expect_equal(res.colnames$sim1[2], "D$LAB_HDL")
    expect_length(res.colnames$sim2, 2)
    expect_equal(res.colnames$sim2[1], "D$LAB_TSC")
    expect_equal(res.colnames$sim2[2], "D$LAB_HDL")
    expect_length(res.colnames$sim3, 2)
    expect_equal(res.colnames$sim3[1], "D$LAB_TSC")
    expect_equal(res.colnames$sim3[2], "D$LAB_HDL")
