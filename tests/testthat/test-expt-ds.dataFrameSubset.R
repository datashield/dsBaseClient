...
{ 
 ...
 subset.by.rows.cols.NA("D","NEGATIVE_INTEGER","NEGATIVE_NUMERIC",c(2,4,9:17),"<=","subset.server",list(ds.test_env$local.values.1[,-1],ds.test_env$local.values.2[,-1],ds.test_env$local.values.3[,-1]))
...
{ 
 ...
 subset.by.rows.cols.nonNA("D","NEGATIVE_INTEGER","NEGATIVE_NUMERIC",c(2,4,9:17),"<=","subset.server",list(ds.test_env$local.values.1[,-1],ds.test_env$local.values.2[,-1],ds.test_env$local.values.3[,-1]))
