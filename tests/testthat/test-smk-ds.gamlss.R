...
test_that("gamlss, RAVEN TEST", {
  ...
  expect_equal(model_correct_raven.DS$study1$results$mu.pen, 0.8507004, tolerance=1e-7)
  ...
  expect_equal(model_correct_raven.DS$study1$results$pen, 0.8506994, tolerance=1e-7)
