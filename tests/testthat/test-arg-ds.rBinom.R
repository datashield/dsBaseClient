...
# context("dsBetaTestClient::ds.rBinom:args test")
...
test_that("rBinom_erros", {
    error.message <- ds.rBinom(seed.as.integer='Value')
...
# context("dsBetaTestClient::ds.rBinom:arg done")
