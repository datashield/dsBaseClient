...
# context("ds.sample::discctrl::setup")
...
test_that("simple c", {
    expect_error(ds.sample(x="D", size=20, seed.as.integer=27), "There are some DataSHIELD errors, list them with datashield.errors()", fixed = TRUE)
...
# context("ds.sample::discctrl::shutdown")
...
# context("ds.sample::discctrl::done")
