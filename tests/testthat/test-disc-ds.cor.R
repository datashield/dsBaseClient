...
test_that("simple disc test, naAction='casewise.complete', type='split'", {
    ...
    expect_equal(res.errors$sim2, "Command 'corDS(\"D3\", NULL, \"casewise.complete\")' failed on 'sim2': Error : ERROR: The ratio of the number of variables over the number of individual-level\n                          records exceeds the allowed threshold, there is a possible risk of disclosure\n", fixed = TRUE)
})
