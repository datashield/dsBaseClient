...
test_that("Check TESTING dataset", {
    ...
    expect_equal(res.length$`length of D in study1`, 16)
    expect_length(res.length$`length of D in study2`, 1)
    expect_equal(res.length$`length of D in study2`, 16)
    expect_length(res.length$`length of D in study3`, 1)
    expect_equal(res.length$`length of D in study3`, 16)
    expect_equal(res.length$`total length of D in all studies combined`, 48)

    res.colnames <- ds.colnames(x='D')
    expect_length(res.colnames, 3)
    expect_length(res.colnames$study1, 16)
    expect_equal(res.colnames$study1, c("CHARACTER", "LOGICAL", "NA_VALUES", "INTEGER", "NULL_VALUES", "NON_NEGATIVE_INTEGER", "POSITIVE_INTEGER", "NEGATIVE_INTEGER", "NUMERIC", "NON_NEGATIVE_NUMERIC", "POSITIVE_NUMERIC", "NEGATIVE_NUMERIC", "FACTOR_CHARACTER", "FACTOR_INTEGER", "IDENTIFIER", "CATEGORY"))
    expect_length(res.colnames$study2, 16)
    expect_equal(res.colnames$study2, c("CHARACTER", "LOGICAL", "NA_VALUES", "INTEGER", "NULL_VALUES", "NON_NEGATIVE_INTEGER", "POSITIVE_INTEGER", "NEGATIVE_INTEGER", "NUMERIC", "NON_NEGATIVE_NUMERIC", "POSITIVE_NUMERIC", "NEGATIVE_NUMERIC", "FACTOR_CHARACTER", "FACTOR_INTEGER", "IDENTIFIER", "CATEGORY"))
    expect_length(res.colnames$study3, 16)
    expect_equal(res.colnames$study3, c("CHARACTER", "LOGICAL", "NA_VALUES", "INTEGER", "NULL_VALUES", "NON_NEGATIVE_INTEGER", "POSITIVE_INTEGER", "NEGATIVE_INTEGER", "NUMERIC", "NON_NEGATIVE_NUMERIC", "POSITIVE_NUMERIC", "NEGATIVE_NUMERIC", "FACTOR_CHARACTER", "FACTOR_INTEGER", "IDENTIFIER", "CATEGORY"))
