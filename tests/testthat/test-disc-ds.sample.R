...
test_that("cov_erros", {
    ...
    expect_equal(res1.errors$sim1, "Command 'sampleDS(x.transmit = \"This_line_is_very_very_very_very_very_very_long\", \n    size.transmit = 1234, replace.transmit = FALSE, prob.transmit = NULL)' failed on 'sim1': Error : FAILED: the character string denoting the argument <x> is too long and may be disclosive - please shorten\n", fixed = TRUE)
    expect_equal(res1.errors$sim2, "Command 'sampleDS(x.transmit = \"This_line_is_very_very_very_very_very_very_long\", \n    size.transmit = 1234, replace.transmit = FALSE, prob.transmit = NULL)' failed on 'sim2': Error : FAILED: the character string denoting the argument <x> is too long and may be disclosive - please shorten\n", fixed = TRUE)
    expect_equal(res1.errors$sim3, "Command 'sampleDS(x.transmit = \"This_line_is_very_very_very_very_very_very_long\", \n    size.transmit = 1234, replace.transmit = FALSE, prob.transmit = NULL)' failed on 'sim3': Error : FAILED: the character string denoting the argument <x> is too long and may be disclosive - please shorten\n", fixed = TRUE)
    ...
    expect_equal(res2.errors$sim1, "Command 'sampleDS(x.transmit = \"D\", size.transmit = 1234, replace.transmit = FALSE, \n    prob.transmit = \"This_line_is_very_very_very_very_very_very_long\")' failed on 'sim1': Error : FAILED: the character string denoting the argument <prob> is too long and may be disclosive - please shorten\n", fixed = TRUE)
    expect_equal(res2.errors$sim2, "Command 'sampleDS(x.transmit = \"D\", size.transmit = 1234, replace.transmit = FALSE, \n    prob.transmit = \"This_line_is_very_very_very_very_very_very_long\")' failed on 'sim2': Error : FAILED: the character string denoting the argument <prob> is too long and may be disclosive - please shorten\n", fixed = TRUE)
    expect_equal(res2.errors$sim3, "Command 'sampleDS(x.transmit = \"D\", size.transmit = 1234, replace.transmit = FALSE, \n    prob.transmit = \"This_line_is_very_very_very_very_very_very_long\")' failed on 'sim3': Error : FAILED: the character string denoting the argument <prob> is too long and may be disclosive - please shorten\n", fixed = TRUE)
    ...
    expect_equal(res3.errors$sim1, "Command 'sampleDS(x.transmit = \"D\", size.transmit = 2, replace.transmit = FALSE, \n    prob.transmit = NULL)' failed on 'sim1': Error : FAILED: disclosure risk, as the length of the subset to be created is less than nfilter.subset\n", fixed = TRUE)
    expect_equal(res3.errors$sim2, "Command 'sampleDS(x.transmit = \"D\", size.transmit = 2, replace.transmit = FALSE, \n    prob.transmit = NULL)' failed on 'sim2': Error : FAILED: disclosure risk, as the length of the subset to be created is less than nfilter.subset\n", fixed = TRUE)
    expect_equal(res3.errors$sim3, "Command 'sampleDS(x.transmit = \"D\", size.transmit = 2, replace.transmit = FALSE, \n    prob.transmit = NULL)' failed on 'sim3': Error : FAILED: disclosure risk, as the length of the subset to be created is less than nfilter.subset\n", fixed = TRUE)
    ...
    expect_equal(res4.errors$sim1, "Command 'sampleDS(x.transmit = \"D\", size.transmit = 2162, replace.transmit = FALSE, \n    prob.transmit = NULL)' failed on 'sim1': Error : FAILED: disclosure risk using differencing: original object length minus subset length less than nfilter.subset\n", fixed = TRUE)
    ...
    expect_equal(res5.errors$sim1, "Command 'sampleDS(x.transmit = \"D\", size.transmit = 3086, replace.transmit = FALSE, \n    prob.transmit = NULL)' failed on 'sim1': Error : FAILED: if sampling without replacement size must be less than or equal to length(x)\n", fixed = TRUE)
    expect_equal(res5.errors$sim2, "Command 'sampleDS(x.transmit = \"D\", size.transmit = 3086, replace.transmit = FALSE, \n    prob.transmit = NULL)' failed on 'sim2': Error : FAILED: disclosure risk using differencing: original object length minus subset length less than nfilter.subset\n", fixed = TRUE)
})
