...
test_that("cov_erros", {
    ...
    expect_equal(res3.errors$sim1, "Command 'sampleDS(x.transmit = \"D\", size.transmit = 2, replace.transmit = FALSE, \n    prob.transmit = NULL)' failed on 'sim1': Error while evaluating 'is.null(base::assign('obj3', value={dsBase::sampleDS(x.transmit = \"D\", size.transmit = 2, replace.transmit = FALSE, prob.transmit = NULL)}))' -> Error in dsBase::sampleDS(x.transmit = \"D\", size.transmit = 2, replace.transmit = FALSE,  : \n  FAILED: disclosure risk, as the length of the subset to be created is less than nfilter.subsetFALSE\n", fixed = TRUE)
    expect_equal(res3.errors$sim2, "Command 'sampleDS(x.transmit = \"D\", size.transmit = 2, replace.transmit = FALSE, \n    prob.transmit = NULL)' failed on 'sim2': Error while evaluating 'is.null(base::assign('obj3', value={dsBase::sampleDS(x.transmit = \"D\", size.transmit = 2, replace.transmit = FALSE, prob.transmit = NULL)}))' -> Error in dsBase::sampleDS(x.transmit = \"D\", size.transmit = 2, replace.transmit = FALSE,  : \n  FAILED: disclosure risk, as the length of the subset to be created is less than nfilter.subsetFALSE\n", fixed = TRUE)
    expect_equal(res3.errors$sim3, "Command 'sampleDS(x.transmit = \"D\", size.transmit = 2, replace.transmit = FALSE, \n    prob.transmit = NULL)' failed on 'sim3': Error while evaluating 'is.null(base::assign('obj3', value={dsBase::sampleDS(x.transmit = \"D\", size.transmit = 2, replace.transmit = FALSE, prob.transmit = NULL)}))' -> Error in dsBase::sampleDS(x.transmit = \"D\", size.transmit = 2, replace.transmit = FALSE,  : \n  FAILED: disclosure risk, as the length of the subset to be created is less than nfilter.subsetFALSE\n", fixed = TRUE)
    ...
    expect_equal(res4.errors$sim1, "Command 'sampleDS(x.transmit = \"D\", size.transmit = 2162, replace.transmit = FALSE, \n    prob.transmit = NULL)' failed on 'sim1': Error while evaluating 'is.null(base::assign('obj4', value={dsBase::sampleDS(x.transmit = \"D\", size.transmit = 2162, replace.transmit = FALSE, prob.transmit = NULL)}))' -> Error in dsBase::sampleDS(x.transmit = \"D\", size.transmit = 2162, replace.transmit = FALSE,  : \n  FAILED: disclosure risk using differencing: original object length minus subset length less than nfilter.subsetFALSE\n", fixed = TRUE)
    ...
    expect_equal(res5.errors$sim1, "Command 'sampleDS(x.transmit = \"D\", size.transmit = 3086, replace.transmit = FALSE, \n    prob.transmit = NULL)' failed on 'sim1': Error while evaluating 'is.null(base::assign('obj5', value={dsBase::sampleDS(x.transmit = \"D\", size.transmit = 3086, replace.transmit = FALSE, prob.transmit = NULL)}))' -> Error in dsBase::sampleDS(x.transmit = \"D\", size.transmit = 3086, replace.transmit = FALSE,  : \n  FAILED: if sampling without replacement size must be less than or equal to length(x)FALSE\n", fixed = TRUE)
    expect_equal(res5.errors$sim2, "Command 'sampleDS(x.transmit = \"D\", size.transmit = 3086, replace.transmit = FALSE, \n    prob.transmit = NULL)' failed on 'sim2': Error while evaluating 'is.null(base::assign('obj5', value={dsBase::sampleDS(x.transmit = \"D\", size.transmit = 3086, replace.transmit = FALSE, prob.transmit = NULL)}))' -> Error in dsBase::sampleDS(x.transmit = \"D\", size.transmit = 3086, replace.transmit = FALSE,  : \n  FAILED: disclosure risk using differencing: original object length minus subset length less than nfilter.subsetFALSE\n", fixed = TRUE)
})
