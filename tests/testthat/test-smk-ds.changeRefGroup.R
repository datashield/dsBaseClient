...
test_that("simple changeRefGroup", {
    ...
    expect_length(res.levels$sim1, 3)
    expect_equal(res.levels$sim1[1], 'obesity')
    expect_equal(res.levels$sim1[2], 'normal')
    expect_equal(res.levels$sim1[3], 'overweight')
    expect_length(res.levels$sim2, 3)
    expect_equal(res.levels$sim2[1], 'obesity')
    expect_equal(res.levels$sim2[2], 'normal')
    expect_equal(res.levels$sim2[3], 'overweight')
    expect_length(res.levels$sim3, 3)
    expect_equal(res.levels$sim3[1], 'obesity')
    expect_equal(res.levels$sim3[2], 'normal')
    expect_equal(res.levels$sim3[3], 'overweight')
})
