...
test_that("data.frame metadata", {
    ...
    expect_length(res$sim1$spec, 3)
    expect_length(res$sim1$spec$cols, 12)
    expect_true(all(class(res$sim1$spec$default) %in% c('collector_guess', 'collector')))
    expect_length(res$sim1$spec$skip, 1)
    ...
    expect_length(res$sim2$spec, 3)
    expect_length(res$sim2$spec$cols, 12)
    expect_true(all(class(res$sim2$spec$default) %in% c('collector_guess', 'collector')))
    expect_length(res$sim2$spec$skip, 1)
    ...
    expect_length(res$sim3$spec, 3)
    expect_length(res$sim3$spec$cols, 12)
    expect_true(all(class(res$sim3$spec$default) %in% c('collector_guess', 'collector')))
    expect_length(res$sim3$spec$skip, 1)
...
test_that("column metadata", {
    ...
    expect_true(all(class(res$sim1) %in% c('list')))
    expect_true(all(names(res$sim1) %in% c('class', 'label', 'opal.value_type', 'opal.entity_type', 'opal.repeatable', 'opal.index', 'opal.nature')))
    expect_length(res$sim1$class, 1)
    ...
    expect_true(all(class(res$sim2) %in% c('list')))
    expect_true(all(names(res$sim2) %in% c('class', 'label', 'opal.value_type', 'opal.entity_type', 'opal.repeatable', 'opal.index', 'opal.nature')))
    expect_length(res$sim2$class, 1)
    ...
    expect_true(all(class(res$sim3) %in% c('list')))
    expect_true(all(names(res$sim3) %in% c('class', 'label', 'opal.value_type', 'opal.entity_type', 'opal.repeatable', 'opal.index', 'opal.nature')))
    expect_length(res$sim3$class, 1)
