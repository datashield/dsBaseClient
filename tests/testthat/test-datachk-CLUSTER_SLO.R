...
test_that("Check CLUSTER SLO dataset", {
    ...
    expect_length(res.class$cluster.slo1, 1)
    expect_equal(res.class$cluster.slo1, "data.frame")
    expect_length(res.class$cluster.slo2, 1)
    expect_equal(res.class$cluster.slo2, "data.frame")
    expect_length(res.class$cluster.slo3, 1)
    expect_equal(res.class$cluster.slo3, "data.frame")
    ...
    expect_length(res.class.ndoctor$cluster.slo1, 1)
    expect_equal(res.class.ndoctor$cluster.slo1, "integer")
    expect_length(res.class.ndoctor$cluster.slo2, 1)
    expect_equal(res.class.ndoctor$cluster.slo2, "integer")
    expect_length(res.class.ndoctor$cluster.slo3, 1)
    expect_equal(res.class.ndoctor$cluster.slo3, "integer")

    res.length.ndoctor <- ds.length(x='D$nDoctor')
    expect_length(res.length.ndoctor, 4)
    expect_length(res.length.ndoctor$`length of D$nDoctor in cluster.slo1`, 1)
    expect_equal(res.length.ndoctor$`length of D$nDoctor in cluster.slo1`, 5637)
    expect_length(res.length.ndoctor$`length of D$nDoctor in cluster.slo2`, 1)
    expect_equal(res.length.ndoctor$`length of D$nDoctor in cluster.slo2`, 5563)
    expect_length(res.length.ndoctor$`length of D$nDoctor in cluster.slo3`, 1)
    expect_equal(res.length.ndoctor$`length of D$nDoctor in cluster.slo3`, 5837)
    expect_length(res.length.ndoctor$`total length of D$nDoctor in all studies combined`, 1)
    expect_equal(res.length.ndoctor$`total length of D$nDoctor in all studies combined`, 17037)
