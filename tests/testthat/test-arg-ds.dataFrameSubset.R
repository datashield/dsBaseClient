...
test_that("dataFrameSubset_erros", {
    ...
    expect_equal(res.errors$sim1, "Command 'dataFrameSubsetDS1(\"M\", \"A\", \"B\", 0, NULL, NULL, FALSE)' failed on 'sim1': Error in data.frame(M) : object 'M' not found\n", fixed = TRUE)
    expect_equal(res.errors$sim2, "Command 'dataFrameSubsetDS1(\"M\", \"A\", \"B\", 0, NULL, NULL, FALSE)' failed on 'sim2': Error in data.frame(M) : object 'M' not found\n", fixed = TRUE)
    expect_equal(res.errors$sim3, "Command 'dataFrameSubsetDS1(\"M\", \"A\", \"B\", 0, NULL, NULL, FALSE)' failed on 'sim3': Error in data.frame(M) : object 'M' not found\n", fixed = TRUE)
})
...
test_that("dataFrameSubset_erros", {
    ...
    expect_length(res.errors, 3)
    expect_equal(res.errors$sim1, "Command 'dataFrameSubsetDS1(\"D\", \"A\", \"B\", 0, NULL, NULL, FALSE)' failed on 'sim1': Error in eval(parse(text = V1.name)) : object 'A' not found\n", fixed = TRUE)
    expect_equal(res.errors$sim2, "Command 'dataFrameSubsetDS1(\"D\", \"A\", \"B\", 0, NULL, NULL, FALSE)' failed on 'sim2': Error in eval(parse(text = V1.name)) : object 'A' not found\n", fixed = TRUE)
    expect_equal(res.errors$sim3, "Command 'dataFrameSubsetDS1(\"D\", \"A\", \"B\", 0, NULL, NULL, FALSE)' failed on 'sim3': Error in eval(parse(text = V1.name)) : object 'A' not found\n", fixed = TRUE)
})
...
test_that("dataFrameSubset_erros", {
    ...
    expect_length(res.errors, 3)
    expect_equal(res.errors$sim1, "Command 'dataFrameSubsetDS1(\"D\", \"D$LAB_TSC\", \"B\", 0, NULL, NULL, FALSE)' failed on 'sim1': Error in eval(parse(text = V2.name)) : object 'B' not found\n", fixed = TRUE)
    expect_equal(res.errors$sim2, "Command 'dataFrameSubsetDS1(\"D\", \"D$LAB_TSC\", \"B\", 0, NULL, NULL, FALSE)' failed on 'sim2': Error in eval(parse(text = V2.name)) : object 'B' not found\n", fixed = TRUE)
    expect_equal(res.errors$sim3, "Command 'dataFrameSubsetDS1(\"D\", \"D$LAB_TSC\", \"B\", 0, NULL, NULL, FALSE)' failed on 'sim3': Error in eval(parse(text = V2.name)) : object 'B' not found\n", fixed = TRUE)
})
