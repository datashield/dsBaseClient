...
test_that("dataFrameSubset_erros", {
    ...
    expect_length(res.errors, 3)
    expect_equal(res.errors$sim1, "Command 'dataFrameSubsetDS1(\"D\", \"A\", \"B\", 0, NULL, NULL, FALSE)' failed on 'sim1': Error while evaluating 'dsBase::dataFrameSubsetDS1(\"D\", \"A\", \"B\", 0, NULL, NULL, FALSE)' -> Error in eval(parse(text = V1.name)) : \n  object 'A' not found\n", fixed = TRUE)
    expect_equal(res.errors$sim2, "Command 'dataFrameSubsetDS1(\"D\", \"A\", \"B\", 0, NULL, NULL, FALSE)' failed on 'sim2': Error while evaluating 'dsBase::dataFrameSubsetDS1(\"D\", \"A\", \"B\", 0, NULL, NULL, FALSE)' -> Error in eval(parse(text = V1.name)) : \n  object 'A' not found\n", fixed = TRUE)
    expect_equal(res.errors$sim3, "Command 'dataFrameSubsetDS1(\"D\", \"A\", \"B\", 0, NULL, NULL, FALSE)' failed on 'sim3': Error while evaluating 'dsBase::dataFrameSubsetDS1(\"D\", \"A\", \"B\", 0, NULL, NULL, FALSE)' -> Error in eval(parse(text = V1.name)) : \n  object 'A' not found\n", fixed = TRUE)
})
...
test_that("dataFrameSubset_erros", {
    ...
    expect_length(res.errors, 3)
    expect_equal(res.errors$sim1, "Command 'dataFrameSubsetDS1(\"D\", \"D$LAB_TSC\", \"B\", 0, NULL, NULL, FALSE)' failed on 'sim1': Error while evaluating 'dsBase::dataFrameSubsetDS1(\"D\", \"D$LAB_TSC\", \"B\", 0, NULL, NULL, FALSE)' -> Error in eval(parse(text = V2.name)) : \n  object 'B' not found\n", fixed = TRUE)
    expect_equal(res.errors$sim2, "Command 'dataFrameSubsetDS1(\"D\", \"D$LAB_TSC\", \"B\", 0, NULL, NULL, FALSE)' failed on 'sim2': Error while evaluating 'dsBase::dataFrameSubsetDS1(\"D\", \"D$LAB_TSC\", \"B\", 0, NULL, NULL, FALSE)' -> Error in eval(parse(text = V2.name)) : \n  object 'B' not found\n", fixed = TRUE)
    expect_equal(res.errors$sim3, "Command 'dataFrameSubsetDS1(\"D\", \"D$LAB_TSC\", \"B\", 0, NULL, NULL, FALSE)' failed on 'sim3': Error while evaluating 'dsBase::dataFrameSubsetDS1(\"D\", \"D$LAB_TSC\", \"B\", 0, NULL, NULL, FALSE)' -> Error in eval(parse(text = V2.name)) : \n  object 'B' not found\n", fixed = TRUE)
})
