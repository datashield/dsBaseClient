...
test_that('all datasets',
          {  
            connect.all.datasets()
            all.local.values <- list(ds.test_env$local.values.1, ds.test_env$local.values.2, ds.test_env$local.values.3)
            .test.data.frame.sorting("D","LOGICAL",FALSE,"numeric","server.data",all.local.values)
            .test.data.frame.sorting("D","INTEGER",FALSE,"numeric","server.data",all.local.values)
            .test.data.frame.sorting("D","POSITIVE_INTEGER",FALSE,"numeric","server.data",all.local.values)
            .test.data.frame.sorting("D","NEGATIVE_INTEGER",FALSE,"numeric","server.data",all.local.values)
            .test.data.frame.sorting("D","NUMERIC",FALSE,"numeric","server.data",all.local.values)
            .test.data.frame.sorting("D","POSITIVE_NUMERIC",FALSE,"numeric","server.data",all.local.values)
            .test.data.frame.sorting("D","NEGATIVE_NUMERIC",FALSE,"numeric","server.data",all.local.values)
            .test.data.frame.sorting("D","IDENTIFIER",FALSE,"numeric","server.data",all.local.values)
            .test.data.frame.sorting("D","CATEGORY",FALSE,"numeric","server.data",all.local.values)
            .test.data.frame.sorting("D","NUMERIC_ONE_CHANGE",FALSE,"numeric","server.data",all.local.values)
            .test.data.frame.sorting("D","INTEGER_ONE_CHANGE",FALSE,"numeric","server.data",all.local.values)
            #.test.data.frame.sorting("D","FACTOR_INTEGER",FALSE,"numeric","server.data",all.local.values)
            #.test.data.frame.sorting("D","FACTOR_CHARACTER",FALSE,"numeric","server.data",all.local.values)
            #.test.data.frame.sorting("D","CHARACTER",FALSE,"numeric","server.data",all.local.values)
          })
...
test_that('dataset 1',
          {  
            connect.dataset.1()
            all.local.values <- list(ds.test_env$local.values.1)
            .test.data.frame.sorting("D","LOGICAL",FALSE,"numeric","server.data",all.local.values)
            .test.data.frame.sorting("D","INTEGER",FALSE,"numeric","server.data",all.local.values)
            .test.data.frame.sorting("D","POSITIVE_INTEGER",FALSE,"numeric","server.data",all.local.values)
            .test.data.frame.sorting("D","NEGATIVE_INTEGER",FALSE,"numeric","server.data",all.local.values)
...
test_that('all datasets',
          {  
            connect.all.datasets()
            all.local.values <- list(ds.test_env$local.values.1, ds.test_env$local.values.2, ds.test_env$local.values.3)
            .test.data.frame.sorting("D","LOGICAL",TRUE,"numeric","server.data",all.local.values)
            .test.data.frame.sorting("D","INTEGER",TRUE,"numeric","server.data",all.local.values)
            .test.data.frame.sorting("D","POSITIVE_INTEGER",TRUE,"numeric","server.data",all.local.values)
            ...
            .test.data.frame.sorting("D","INTEGER_ONE_CHANGE",TRUE,"numeric","server.data",all.local.values)
            #.test.data.frame.sorting("D","FACTOR_INTEGER",TRUE,"numeric","server.data",all.local.values)
            #.test.data.frame.sorting("D","FACTOR_CHARACTER",TRUE,"numeric","server.data",all.local.values)
            #.test.data.frame.sorting("D","CHARACTER",TRUE,"numeric","server.data",all.local.values)
...
test_that('all datasets',
          {  
            ...
            #}
            #.test.data.frame.sorting("D","LOGICAL",FALSE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","INTEGER",FALSE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","POSITIVE_INTEGER",FALSE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","NEGATIVE_INTEGER",FALSE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","NUMERIC",FALSE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","POSITIVE_NUMERIC",FALSE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","NEGATIVE_NUMERIC",FALSE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","IDENTIFIER",FALSE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","CATEGORY",FALSE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","NUMERIC_ONE_CHANGE",FALSE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","INTEGER_ONE_CHANGE",FALSE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","FACTOR_INTEGER",FALSE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","FACTOR_CHARACTER",FALSE,"alphabetic","server.data",all.local.values) 
            #.test.data.frame.sorting("D","CHARACTER",FALSE,"alphabetic","server.data",all.local.values)
          })
...
test_that('all datasets',
          {  
            ...
            #  colnames(local.df.list[[i]])<-ds.colnames("D",datasources = ds.test_env$connections[i][[1]])
            #}
            #.test.data.frame.sorting("D","LOGICAL",TRUE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","INTEGER",TRUE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","POSITIVE_INTEGER",TRUE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","NEGATIVE_INTEGER",TRUE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","NUMERIC",TRUE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","POSITIVE_NUMERIC",TRUE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","NEGATIVE_NUMERIC",TRUE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","IDENTIFIER",TRUE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","CATEGORY",TRUE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","NUMERIC_ONE_CHANGE",TRUE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","INTEGER_ONE_CHANGE",TRUE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","FACTOR_INTEGER",TRUE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","FACTOR_CHARACTER",TRUE,"alphabetic","server.data",all.local.values)
            #.test.data.frame.sorting("D","CHARACTER",TRUE,"alphabetic","server.data",all.local.values)
          })
