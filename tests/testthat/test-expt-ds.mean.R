...
test_that("combined data set",
{
  ...
  .test.mean.combined('D$INTEGER',ds.test_env$combined.local.values[,'INTEGER'])
  .test.mean.combined('D$NON_NEGATIVE_INTEGER',ds.test_env$combined.local.values[,'NON_NEGATIVE_INTEGER'])
  .test.mean.combined('D$POSITIVE_INTEGER',ds.test_env$combined.local.values[,'POSITIVE_INTEGER'])
  .test.mean.combined('D$NEGATIVE_INTEGER',ds.test_env$combined.local.values[,'NEGATIVE_INTEGER']) 
  .test.mean.combined('D$NUMERIC',ds.test_env$combined.local.values[,'NUMERIC'])
  .test.mean.combined('D$NON_NEGATIVE_NUMERIC',ds.test_env$combined.local.values[,'NON_NEGATIVE_NUMERIC'])
  .test.mean.combined('D$POSITIVE_NUMERIC',ds.test_env$combined.local.values[,'POSITIVE_NUMERIC'])
  .test.mean.combined('D$NEGATIVE_NUMERIC',ds.test_env$combined.local.values[,'NEGATIVE_NUMERIC']) 
})
...
{
  connect.all.datasets()
  .test.mean.large('D$INTEGER',ds.test_env$combined.local.values[,'INTEGER'])
  .test.mean.large('D$NON_NEGATIVE_INTEGER',ds.test_env$combined.local.values[,'NON_NEGATIVE_INTEGER'])
  .test.mean.large('D$POSITIVE_INTEGER',ds.test_env$combined.local.values[,'POSITIVE_INTEGER'])
  .test.mean.large('D$NEGATIVE_INTEGER',ds.test_env$combined.local.values[,'NEGATIVE_INTEGER']) 
  .test.mean.large('D$NUMERIC',ds.test_env$combined.local.values[,'NUMERIC'])
  .test.mean.large('D$NON_NEGATIVE_NUMERIC',ds.test_env$combined.local.values[,'NON_NEGATIVE_NUMERIC'])
  .test.mean.large('D$POSITIVE_NUMERIC',ds.test_env$combined.local.values[,'POSITIVE_NUMERIC'])
  .test.mean.large('D$NEGATIVE_NUMERIC',ds.test_env$combined.local.values[,'NEGATIVE_NUMERIC']) 
})
