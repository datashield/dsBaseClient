...
test_that("simple test", {
    ...
    expect_equal(res$survival1[[8]], "D$survtime and D$time.id")
    ...
    expect_equal(res$survival2[[8]], "D$survtime and D$time.id")
    ...
    expect_equal(res$survival3[[8]], "D$survtime and D$time.id")
    expect_length(res$survival3[[9]], 2)
    expect_equal(res$survival3[[9]][1], 0.0215, tolerance=1e6)
    expect_equal(res$survival3[[9]][2], 0.0972, tolerance=1e6)
})
