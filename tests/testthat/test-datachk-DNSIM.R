...
test_that("Check DASIM dataset", {
    ...
    expect_equal(res.class$sim1, "data.frame")
    expect_length(res.class$sim2, 1)
    expect_equal(res.class$sim2, "data.frame")
    expect_length(res.class$sim3, 1)
    expect_equal(res.class$sim3, "data.frame")
    ...
    res.class.lan_hdl <- ds.class(x='D$LAB_HDL')
    expect_length(res.class.lan_hdl, 3)
    expect_length(res.class.lan_hdl$sim1, 1)
    expect_equal(res.class.lan_hdl$sim1, "numeric")
    expect_length(res.class.lan_hdl$sim2, 1)
    expect_equal(res.class.lan_hdl$sim2, "numeric")
    expect_length(res.class.lan_hdl$sim3, 1)
    expect_equal(res.class.lan_hdl$sim3, "numeric")
