...
context("ds.dataFrameSubset()::expt::multiple::parameter_class")
...
context("ds.dataFrameSubset()::expt::single::parameter_class")
test_that('dataset 1',
          {  
            connect.dataset.1()
            .test.function.parameters("D","D$INTEGER","D$NUMERIC",">",1:3,7:9,FALSE,"subset.server")
...
context("ds.dataFrameSubset()::expt::single::all_columns")
test_that('dataset 2',
          {  
            connect.dataset.2()
            .test.data.frame.creation("D","INTEGER","NUMERIC",">","subset.server")
...
context("ds.dataFrameSubset()::expt::single::all_columns::subset_by_rows")
test_that("dataset 3",
          { 
            connect.dataset.3()
...
context("ds.dataFrameSubset()::expt::single::subset_by_rows_columns")
test_that("dataset 1",
          { 
            connect.dataset.1()
