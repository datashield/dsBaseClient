#' @title ds.asInteger.o calling assign function asIntegerDS.o
...
#' @export
ds.asInteger.o = function(x.name=NULL, newobj=NULL, datasources=NULL){
  ...
  if(is.null(newobj)){
	...
	calltext <- call("asIntegerDS.o", x.name)
