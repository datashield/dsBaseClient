...
#' that table object. The true counts in the studyside vector
...
#' for potential disclosure risk. Because the table object on the
...
#' in each of the 2 dimensional tables produced in the output.  The <cvar>
#' argument identifies the variable defining the columns in the 2 dimensional
#' tables produced in the output. In creating a 3-dimensional table the
...
#' defaults to FALSE. If there is at least one expected cell
...
#' there is an error for some other reason). The clientside output from
...
#' the <newobj> argument or set to 'newObj' by default. Further information
