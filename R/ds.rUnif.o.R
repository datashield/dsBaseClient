#' @title ds.rUnif.o calling rUnifDS.o and setSeedDS.o
...
#' @export
ds.rUnif.o<-function(samp.size=1,min=0,max=1, newobj="newObject", seed.as.integer=NULL, return.full.seed.as.set=FALSE,
...
toAssign<-paste0("rUnifDS.o(",samp.size[k],",",min, ",", max, ",", force.output.to.k.decimal.places,")")
