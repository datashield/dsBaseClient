...
#'
#' @param vector `character` Name of the table on the server side that holds the information to be plotted later
#' @param datasources a list of [DSConnection-class()] (default `NULL`) objects obtained after login
#'
#' @return Does not return nothing, it creates the table `"boxPlotRawDataNumeric"` on the server arranged to be passed to the
