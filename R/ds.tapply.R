...
#' @details This function is similar to a native R function `tapply()`.
...
#' @return `ds.tapply` returns to the client-side an array of the summarized values.
