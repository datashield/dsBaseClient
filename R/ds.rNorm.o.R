#' @title ds.rNorm.o calling rNormDS.o and setSeedDS.o
...
#' @export
ds.rNorm.o<-function(samp.size=1,mean=0,sd=1, newobj="newObject", seed.as.integer=NULL, return.full.seed.as.set=FALSE,
...
toAssign<-paste0("rNormDS.o(",samp.size[k],",",mean, ",", sd, ",", force.output.to.k.decimal.places,")")
