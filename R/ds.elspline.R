...
#' @description This function is based on the native R function `elspline` from the
...
#' variable that is stored on the data servers. Default `elspline.newobj`. 
...
#' `newobj` argument (or its default name "elspline.newobj"), is assigned on the serverside.
