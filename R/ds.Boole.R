...
#' 
#' 
#' @details A combination of operators reflected in \code{AND} 
...
#' is to be applied. 
#' @param V2 A character string specifying the name of the vector or scalar to which \code{V1} is to
#' be compared. 
