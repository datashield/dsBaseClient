#' @title ds.asNumeric.o calling assign function asNumericDS.o
...
#' to NULL, the name of the new variable is defaulted to <x.name>.num
...
#' @return the object specified by the <newobj> argument (or by default <x.name>.num
...
#' @export
ds.asNumeric.o = function(x.name=NULL, newobj=NULL, datasources=NULL){
  ...
  if(is.null(newobj)){
	...
	calltext <- call("asNumericDS.o", x.name)
