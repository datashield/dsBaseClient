#' @title ds.asMatrix.o calling assign function asMatrixDS.o
#' @description this function is based on the native R function {as.matrix}
#' @details This function is based on the native R function {as.matrix}
...
#' and in DataSHIELD this is called by ds.asDataMatrix.o which calls
#' asDataMatrixDS.o 
...
#' @export
ds.asMatrix.o = function(x.name=NULL, newobj=NULL, datasources=NULL){
