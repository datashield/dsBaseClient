...
#' @param vector a vector that holds the objects to be combined (together with additional options)
...
ds.data.frame = function(datasources=NULL, vector=NULL, newobj=NULL){
  ...
  #     
  #     if(is.null(flag)){
  #       # this will call the data.frame function defined on the server side
