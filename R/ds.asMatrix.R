...
#' original class you should use the function `ds.asDataMatrix`. 
#' 
...
#'  that is stored on the data servers. Default `asmatrix.newobj`.
...
#' @return `ds.asMatrix` returns the object converted into a matrix 
