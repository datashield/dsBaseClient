...
#' the data repository servers specified by `datasources` argument.\cr
#' 
...
#' interpreted.
#' 
#' (5) `nfilter.string`, Short to be used when a string must be specified but that when valid that
...
#' @return `ds.listDisclosureSettings` returns a list containing the current settings of the
#' `nfilters` in each study specified. 
