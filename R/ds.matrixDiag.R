...
#' value specified in the `aim` argument:\cr
...
#' If the vector length is `k`, the output matrix has `k` rows and `k` columns.\cr
...
#' matrix are determined by the value of the `nrows.scalar` argument.\cr
...
#' @return `ds.matrixDiag` returns to the server-side the square matrix diagonal. 
