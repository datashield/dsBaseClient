...
using the relevant R symbols (e.g. '+' for addtion, '\*' for
multiplication, '-' for substraction and '/' for division). This might
...
multiplication, a substraction or a division. If one or more vectors
have a missing value at any one entry (i.e. observation), the operation
